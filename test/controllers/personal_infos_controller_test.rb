...
class PersonalInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personal_info" do
    assert_difference('PersonalInfo.count') do
      post personal_infos_url, params: { personal_info: { date_of_birth: @personal_info.date_of_birth, fathers_name: @personal_info.fathers_name, hall: @personal_info.hall, mothers_name: @personal_info.mothers_name, session: @personal_info.session } }
    end
  ...
  test "should update personal_info" do
    patch personal_info_url(@personal_info), params: { personal_info: { date_of_birth: @personal_info.date_of_birth, fathers_name: @personal_info.fathers_name, hall: @personal_info.hall, mothers_name: @personal_info.mothers_name, session: @personal_info.session } }
